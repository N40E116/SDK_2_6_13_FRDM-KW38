...
#define FSL_LIN_DRIVER_VERSION (MAKE_VERSION(2, 3, 0))
...
typedef enum
{
    ...
    LIN_NO_RESPONSE_ERROR         = 0x11U  /*!< Indicate that the last frame was missing response */
} lin_event_id_t;
...
typedef struct
{
    ...
    volatile bool framingError;                 /*!< Used to mark the framing error detection */
} lin_state_t;
