...
#define RSIM_CONTROL_BLE_RF_OSC_REQ_EN_ASSIGN(x)        (((uint32_t)(((uint32_t)(x)) << RSIM_CONTROL_BLE_RF_OSC_REQ_EN_SHIFT)) & RSIM_CONTROL_BLE_RF_OSC_REQ_EN_MASK)
...
/*---------------------------------------------------------------------------
 * Name: PWRLib_MCU_Enter_lls1_2_3
 * Description: Puts the processor into LLS1, LLS2 or LLS3 ( Low Leakage Stop 0-3).
 * Parameters: -
 * Return: -
 *---------------------------------------------------------------------------*/
#if (cPWR_EnableDeepSleepMode_1 || cPWR_EnableDeepSleepMode_2 || cPWR_EnableDeepSleepMode_3)
bool PWRLib_MCU_Enter_lls1_2_3(void);
#endif
