...
/* Number of iteration for the CPU to wait for LinkLayer to enter DSM in case of late event during lowpower entry
        Typically number of iterations to be set to 1040 for 300 us delay @48Mhz Mhz -
        Same value can be used @32Mhz, in this case, the delay will be longer without any risk  */
#ifndef cPWR_WaitLlDelayOnLateIrq
#define cPWR_WaitLlDelayOnLateIrq                1040u
#endif

/* Number of iteration for the CPU to wait for the oscillator to switch off */
#ifndef cPWR_WaitRFOscillatorSwitchOff
#define cPWR_WaitRFOscillatorSwitchOff            5000u
#endif

/* Number of iteration for the CPU to wait until RF Ready bit will be activated */
...
/* Usually in low power mode 9 ADV is done at each wakeup whatever the wakeup source */
/* when PWR_Mode9AdvOnLPTimerOnly flag is set, ADV is done only on low power timer expiry  */
#ifndef PWR_Mode9AdvOnLPTimerOnly
#define PWR_Mode9AdvOnLPTimerOnly               0u
#endif
