...
const xcvr_common_config_t xcvr_common_config =
{
...
#if RF_OSC_26MHZ == 1
    .end_of_seq = XCVR_TSM_END_OF_SEQ_END_OF_RX_WD(0x6D+PHY_EN_DELAY + RFNA_DEL)|
                XCVR_TSM_END_OF_SEQ_END_OF_RX_WU(0x6C+PHY_EN_DELAY + RFNA_DEL)|
                XCVR_TSM_END_OF_SEQ_END_OF_TX_WD(0x65 + RFNA_DEL)|
                XCVR_TSM_END_OF_SEQ_END_OF_TX_WU(0x64 + RFNA_DEL),
#else
    .end_of_seq = XCVR_TSM_END_OF_SEQ_END_OF_RX_WD(0x69+PHY_EN_DELAY + RFNA_DEL)|
                XCVR_TSM_END_OF_SEQ_END_OF_RX_WU(0x68+PHY_EN_DELAY + RFNA_DEL)|
                XCVR_TSM_END_OF_SEQ_END_OF_TX_WD(0x65 + RFNA_DEL)|
                XCVR_TSM_END_OF_SEQ_END_OF_TX_WU(0x64 + RFNA_DEL),
#endif /* RF_OSC_26MHZ == 1 */
    ...
    .fast_ctrl1 = XCVR_TSM_FAST_CTRL1_FAST_RX2TX_EN(0)|
                XCVR_TSM_FAST_CTRL1_FAST_RX2TX_START(0x00 + RFNA_DEL)|
...
#if RF_OSC_26MHZ == 1
    .fast_ctrl2 = XCVR_TSM_FAST_CTRL2_FAST_DEST_RX(0x6A + RFNA_DEL)|
                XCVR_TSM_FAST_CTRL2_FAST_DEST_TX(0x42 + RFNA_DEL)|
                XCVR_TSM_FAST_CTRL2_FAST_START_RX(0x2C + RFNA_DEL)|
                XCVR_TSM_FAST_CTRL2_FAST_START_TX(0x08 + RFNA_DEL),
#else
    .fast_ctrl2 = XCVR_TSM_FAST_CTRL2_FAST_DEST_RX(0x66 + RFNA_DEL)|
                XCVR_TSM_FAST_CTRL2_FAST_DEST_TX(0x42 + RFNA_DEL)|
                XCVR_TSM_FAST_CTRL2_FAST_START_RX(0x28 + RFNA_DEL)|
                XCVR_TSM_FAST_CTRL2_FAST_START_TX(0x08 + RFNA_DEL),
#endif /* RF_OSC_26MHZ == 1 */
...
#if RF_OSC_26MHZ == 1
    .recycle_count = XCVR_TSM_RECYCLE_COUNT_RECYCLE_COUNT0(0x6A + RFNA_DEL)|
                XCVR_TSM_RECYCLE_COUNT_RECYCLE_COUNT1(0x06 + RFNA_DEL)|
                XCVR_TSM_RECYCLE_COUNT_RECYCLE_COUNT2(0x20 + RFNA_DEL),
#else
    .recycle_count = XCVR_TSM_RECYCLE_COUNT_RECYCLE_COUNT0(0x66 + RFNA_DEL)|
                XCVR_TSM_RECYCLE_COUNT_RECYCLE_COUNT1(0x06 + RFNA_DEL)|
                XCVR_TSM_RECYCLE_COUNT_RECYCLE_COUNT2(0x1C + RFNA_DEL),
#endif /* RF_OSC_26MHZ == 1 */

    /* TIMING00 configuration, dependencies: ['COM', 'COM', 'COM', 'COM'] */
#if RF_OSC_26MHZ == 1
    .timing00 = XCVR_TSM_TIMING00_BB_LDO_HF_EN_RX_HI(0x00 + RFNA_DEL)|
                XCVR_TSM_TIMING00_BB_LDO_HF_EN_RX_LO(0x6D+PHY_EN_DELAY + RFNA_DEL)|
                XCVR_TSM_TIMING00_BB_LDO_HF_EN_TX_HI(0x00 + RFNA_DEL)|
                XCVR_TSM_TIMING00_BB_LDO_HF_EN_TX_LO(0x65 + RFNA_DEL),
#else
    .timing00 = XCVR_TSM_TIMING00_BB_LDO_HF_EN_RX_HI(0x00 + RFNA_DEL)|
                XCVR_TSM_TIMING00_BB_LDO_HF_EN_RX_LO(0x69+PHY_EN_DELAY + RFNA_DEL)|
                XCVR_TSM_TIMING00_BB_LDO_HF_EN_TX_HI(0x00 + RFNA_DEL)|
                XCVR_TSM_TIMING00_BB_LDO_HF_EN_TX_LO(0x65 + RFNA_DEL),
#endif /* RF_OSC_26MHZ == 1 */
...
#if RF_OSC_26MHZ == 1
    .timing01 = XCVR_TSM_TIMING01_BB_LDO_ADCDAC_EN_RX_HI(0x00 + RFNA_DEL)|
                XCVR_TSM_TIMING01_BB_LDO_ADCDAC_EN_RX_LO(0x6D+PHY_EN_DELAY + RFNA_DEL)|
                XCVR_TSM_TIMING01_BB_LDO_ADCDAC_EN_TX_HI(0x00 + RFNA_DEL)|
                XCVR_TSM_TIMING01_BB_LDO_ADCDAC_EN_TX_LO(0x65 + RFNA_DEL),
#else
    .timing01 = XCVR_TSM_TIMING01_BB_LDO_ADCDAC_EN_RX_HI(0x00 + RFNA_DEL)|
                XCVR_TSM_TIMING01_BB_LDO_ADCDAC_EN_RX_LO(0x69+PHY_EN_DELAY + RFNA_DEL)|
                XCVR_TSM_TIMING01_BB_LDO_ADCDAC_EN_TX_HI(0x00 + RFNA_DEL)|
                XCVR_TSM_TIMING01_BB_LDO_ADCDAC_EN_TX_LO(0x65 + RFNA_DEL),
#endif /* RF_OSC_26MHZ == 1 */
...
#if RF_OSC_26MHZ == 1
    .timing02 = XCVR_TSM_TIMING02_BB_LDO_BBA_EN_RX_HI(0x00 + RFNA_DEL)|
                XCVR_TSM_TIMING02_BB_LDO_BBA_EN_RX_LO(0x6D+PHY_EN_DELAY + RFNA_DEL),
#else
    .timing02 = XCVR_TSM_TIMING02_BB_LDO_BBA_EN_RX_HI(0x00 + RFNA_DEL)|
                XCVR_TSM_TIMING02_BB_LDO_BBA_EN_RX_LO(0x69+PHY_EN_DELAY + RFNA_DEL),
#endif /* RF_OSC_26MHZ == 1 */

    /* TIMING03 configuration, dependencies: ['COM', 'COM', 'COM', 'COM'] */
#if RF_OSC_26MHZ == 1
    .timing03 = XCVR_TSM_TIMING03_BB_LDO_PD_EN_RX_HI(0x00 + RFNA_DEL)|
                XCVR_TSM_TIMING03_BB_LDO_PD_EN_RX_LO(0x6D+PHY_EN_DELAY + RFNA_DEL)|
                XCVR_TSM_TIMING03_BB_LDO_PD_EN_TX_HI(0x00 + RFNA_DEL)|
                XCVR_TSM_TIMING03_BB_LDO_PD_EN_TX_LO(0x65 + RFNA_DEL),
#else
    .timing03 = XCVR_TSM_TIMING03_BB_LDO_PD_EN_RX_HI(0x00 + RFNA_DEL)|
                XCVR_TSM_TIMING03_BB_LDO_PD_EN_RX_LO(0x69+PHY_EN_DELAY + RFNA_DEL)|
                XCVR_TSM_TIMING03_BB_LDO_PD_EN_TX_HI(0x00 + RFNA_DEL)|
                XCVR_TSM_TIMING03_BB_LDO_PD_EN_TX_LO(0x65 + RFNA_DEL),
#endif /* RF_OSC_26MHZ == 1 */
...
#if RF_OSC_26MHZ == 1
    .timing04 = XCVR_TSM_TIMING04_BB_LDO_FDBK_EN_RX_HI(0x00 + RFNA_DEL)|
                XCVR_TSM_TIMING04_BB_LDO_FDBK_EN_RX_LO(0x6D+PHY_EN_DELAY + RFNA_DEL)|
                XCVR_TSM_TIMING04_BB_LDO_FDBK_EN_TX_HI(0x00 + RFNA_DEL)|
                XCVR_TSM_TIMING04_BB_LDO_FDBK_EN_TX_LO(0x65 + RFNA_DEL),
#else
    .timing04 = XCVR_TSM_TIMING04_BB_LDO_FDBK_EN_RX_HI(0x00 + RFNA_DEL)|
                XCVR_TSM_TIMING04_BB_LDO_FDBK_EN_RX_LO(0x69+PHY_EN_DELAY + RFNA_DEL)|
                XCVR_TSM_TIMING04_BB_LDO_FDBK_EN_TX_HI(0x00 + RFNA_DEL)|
                XCVR_TSM_TIMING04_BB_LDO_FDBK_EN_TX_LO(0x65 + RFNA_DEL),
#endif /* RF_OSC_26MHZ == 1 */
...
#if RF_OSC_26MHZ == 1
    .timing05 = XCVR_TSM_TIMING05_BB_LDO_VCOLO_EN_RX_HI(0x00 + RFNA_DEL)|
                XCVR_TSM_TIMING05_BB_LDO_VCOLO_EN_RX_LO(0x6D+PHY_EN_DELAY + RFNA_DEL)|
                XCVR_TSM_TIMING05_BB_LDO_VCOLO_EN_TX_HI(0x00 + RFNA_DEL)|
                XCVR_TSM_TIMING05_BB_LDO_VCOLO_EN_TX_LO(0x65 + RFNA_DEL),
#else
    .timing05 = XCVR_TSM_TIMING05_BB_LDO_VCOLO_EN_RX_HI(0x00 + RFNA_DEL)|
                XCVR_TSM_TIMING05_BB_LDO_VCOLO_EN_RX_LO(0x69+PHY_EN_DELAY + RFNA_DEL)|
                XCVR_TSM_TIMING05_BB_LDO_VCOLO_EN_TX_HI(0x00 + RFNA_DEL)|
                XCVR_TSM_TIMING05_BB_LDO_VCOLO_EN_TX_LO(0x65 + RFNA_DEL),
#endif /* RF_OSC_26MHZ == 1 */
...
#if RF_OSC_26MHZ == 1
    .timing06 = XCVR_TSM_TIMING06_BB_LDO_VTREF_EN_RX_HI(0x00 + RFNA_DEL)|
                XCVR_TSM_TIMING06_BB_LDO_VTREF_EN_RX_LO(0x6D+PHY_EN_DELAY + RFNA_DEL)|
                XCVR_TSM_TIMING06_BB_LDO_VTREF_EN_TX_HI(0x00 + RFNA_DEL)|
                XCVR_TSM_TIMING06_BB_LDO_VTREF_EN_TX_LO(0x65 + RFNA_DEL),
#else
    .timing06 = XCVR_TSM_TIMING06_BB_LDO_VTREF_EN_RX_HI(0x00 + RFNA_DEL)|
                XCVR_TSM_TIMING06_BB_LDO_VTREF_EN_RX_LO(0x69+PHY_EN_DELAY + RFNA_DEL)|
                XCVR_TSM_TIMING06_BB_LDO_VTREF_EN_TX_HI(0x00 + RFNA_DEL)|
                XCVR_TSM_TIMING06_BB_LDO_VTREF_EN_TX_LO(0x65 + RFNA_DEL),
#endif /* RF_OSC_26MHZ == 1 */

    /* TIMING07 configuration, dependencies: ['COM', 'COM', 'COM', 'COM'] */
    .timing07 = XCVR_TSM_TIMING07_BB_LDO_FDBK_BLEED_EN_RX_HI(0x00 + RFNA_DEL)|
                XCVR_TSM_TIMING07_BB_LDO_FDBK_BLEED_EN_RX_LO(0x05 + RFNA_DEL)|
                XCVR_TSM_TIMING07_BB_LDO_FDBK_BLEED_EN_TX_HI(0x00 + RFNA_DEL)|
                XCVR_TSM_TIMING07_BB_LDO_FDBK_BLEED_EN_TX_LO(0x05 + RFNA_DEL),

    /* TIMING08 configuration, dependencies: ['COM', 'COM', 'COM', 'COM'] */
    .timing08 = XCVR_TSM_TIMING08_BB_LDO_VCOLO_BLEED_EN_RX_HI(0x00 + RFNA_DEL)|
                XCVR_TSM_TIMING08_BB_LDO_VCOLO_BLEED_EN_RX_LO(0x03 + RFNA_DEL)|
                XCVR_TSM_TIMING08_BB_LDO_VCOLO_BLEED_EN_TX_HI(0x00 + RFNA_DEL)|
                XCVR_TSM_TIMING08_BB_LDO_VCOLO_BLEED_EN_TX_LO(0x03 + RFNA_DEL),

    /* TIMING09 configuration, dependencies: ['COM', 'COM', 'COM', 'COM'] */
    .timing09 = XCVR_TSM_TIMING09_BB_LDO_VCOLO_FASTCHARGE_EN_RX_HI(0x00 + RFNA_DEL)|
                XCVR_TSM_TIMING09_BB_LDO_VCOLO_FASTCHARGE_EN_RX_LO(0x03 + RFNA_DEL)|
                XCVR_TSM_TIMING09_BB_LDO_VCOLO_FASTCHARGE_EN_TX_HI(0x00 + RFNA_DEL)|
                XCVR_TSM_TIMING09_BB_LDO_VCOLO_FASTCHARGE_EN_TX_LO(0x03 + RFNA_DEL),

    /* TIMING10 configuration, dependencies: ['COM', 'COM', 'COM', 'COM'] */
#if RF_OSC_26MHZ == 1
    .timing10 = XCVR_TSM_TIMING10_BB_XTAL_PLL_REF_CLK_EN_RX_HI(0x03 + RFNA_DEL)|
                XCVR_TSM_TIMING10_BB_XTAL_PLL_REF_CLK_EN_RX_LO(0x6D+PHY_EN_DELAY + RFNA_DEL)|
                XCVR_TSM_TIMING10_BB_XTAL_PLL_REF_CLK_EN_TX_HI(0x03 + RFNA_DEL)|
                XCVR_TSM_TIMING10_BB_XTAL_PLL_REF_CLK_EN_TX_LO(0x65 + RFNA_DEL),
#else
    .timing10 = XCVR_TSM_TIMING10_BB_XTAL_PLL_REF_CLK_EN_RX_HI(0x03 + RFNA_DEL)|
                XCVR_TSM_TIMING10_BB_XTAL_PLL_REF_CLK_EN_RX_LO(0x69+PHY_EN_DELAY + RFNA_DEL)|
                XCVR_TSM_TIMING10_BB_XTAL_PLL_REF_CLK_EN_TX_HI(0x03 + RFNA_DEL)|
                XCVR_TSM_TIMING10_BB_XTAL_PLL_REF_CLK_EN_TX_LO(0x65 + RFNA_DEL),
#endif /* RF_OSC_26MHZ == 1 */

    /* TIMING11 configuration, dependencies: ['COM', 'COM'] */
    .timing11 = XCVR_TSM_TIMING11_BB_XTAL_DAC_REF_CLK_EN_TX_HI(0x03 + RFNA_DEL)|
                XCVR_TSM_TIMING11_BB_XTAL_DAC_REF_CLK_EN_TX_LO(0x65 + RFNA_DEL),

    /* TIMING12 configuration, dependencies: ['COM', 'COM'] */
#if RF_OSC_26MHZ == 1
    .timing12 = XCVR_TSM_TIMING12_RXTX_AUXPLL_VCO_REF_CLK_EN_RX_HI(0x03 + RFNA_DEL)|
                XCVR_TSM_TIMING12_RXTX_AUXPLL_VCO_REF_CLK_EN_RX_LO(0x6D+PHY_EN_DELAY + RFNA_DEL),
#else
    .timing12 = XCVR_TSM_TIMING12_RXTX_AUXPLL_VCO_REF_CLK_EN_RX_HI(0x03 + RFNA_DEL)|
                XCVR_TSM_TIMING12_RXTX_AUXPLL_VCO_REF_CLK_EN_RX_LO(0x69+PHY_EN_DELAY + RFNA_DEL),
#endif /* RF_OSC_26MHZ == 1 */

    /* TIMING13 configuration, dependencies: ['COM', 'COM', 'COM', 'COM'] */
    .timing13 = XCVR_TSM_TIMING13_PLL_LOOP_IS_OPEN_RX_HI(0x00 + RFNA_DEL)|
                XCVR_TSM_TIMING13_PLL_LOOP_IS_OPEN_RX_LO(0x18 + RFNA_DEL)|
                XCVR_TSM_TIMING13_PLL_LOOP_IS_OPEN_TX_HI(0x00 + RFNA_DEL)|
                XCVR_TSM_TIMING13_PLL_LOOP_IS_OPEN_TX_LO(0x4C + RFNA_DEL),
...
#if RF_OSC_26MHZ == 1
    .timing15 = XCVR_TSM_TIMING15_SY_VCO_EN_RX_HI(0x03 + RFNA_DEL)|
                XCVR_TSM_TIMING15_SY_VCO_EN_RX_LO(0x6D+PHY_EN_DELAY + RFNA_DEL)|
                XCVR_TSM_TIMING15_SY_VCO_EN_TX_HI(0x03 + RFNA_DEL)|
                XCVR_TSM_TIMING15_SY_VCO_EN_TX_LO(0x65 + RFNA_DEL),
#else
    .timing15 = XCVR_TSM_TIMING15_SY_VCO_EN_RX_HI(0x03 + RFNA_DEL)|
                XCVR_TSM_TIMING15_SY_VCO_EN_RX_LO(0x69+PHY_EN_DELAY + RFNA_DEL)|
                XCVR_TSM_TIMING15_SY_VCO_EN_TX_HI(0x03 + RFNA_DEL)|
                XCVR_TSM_TIMING15_SY_VCO_EN_TX_LO(0x65 + RFNA_DEL),
#endif /* RF_OSC_26MHZ == 1 */
...
#if RF_OSC_26MHZ == 1
    .timing16 = XCVR_TSM_TIMING16_SY_LO_RX_BUF_EN_RX_HI(0x20 + RFNA_DEL)|
                XCVR_TSM_TIMING16_SY_LO_RX_BUF_EN_RX_LO(0x6D+PHY_EN_DELAY + RFNA_DEL),
#else
    .timing16 = XCVR_TSM_TIMING16_SY_LO_RX_BUF_EN_RX_HI(0x1C + RFNA_DEL)|
                XCVR_TSM_TIMING16_SY_LO_RX_BUF_EN_RX_LO(0x69+PHY_EN_DELAY + RFNA_DEL),
#endif /* RF_OSC_26MHZ == 1 */

    /* TIMING17 configuration, dependencies: ['COM', 'COM'] */
#if RF_OSC_26MHZ == 1
    .timing17 = XCVR_TSM_TIMING17_SY_LO_TX_BUF_EN_TX_HI(0x05 + RFNA_DEL)|
                XCVR_TSM_TIMING17_SY_LO_TX_BUF_EN_TX_LO(0x65 + RFNA_DEL),
#else
    .timing17 = XCVR_TSM_TIMING17_SY_LO_TX_BUF_EN_TX_HI(0x05 + RFNA_DEL)|
                XCVR_TSM_TIMING17_SY_LO_TX_BUF_EN_TX_LO(0x65 + RFNA_DEL),
#endif /* RF_OSC_26MHZ == 1 */
...
#if RF_OSC_26MHZ == 1
    .timing18 = XCVR_TSM_TIMING18_SY_DIVN_EN_RX_HI(0x05 + RFNA_DEL)|
                XCVR_TSM_TIMING18_SY_DIVN_EN_RX_LO(0x6D+PHY_EN_DELAY + RFNA_DEL)|
                XCVR_TSM_TIMING18_SY_DIVN_EN_TX_HI(0x05 + RFNA_DEL)|
                XCVR_TSM_TIMING18_SY_DIVN_EN_TX_LO(0x65 + RFNA_DEL),
#else
    .timing18 = XCVR_TSM_TIMING18_SY_DIVN_EN_RX_HI(0x05 + RFNA_DEL)|
                XCVR_TSM_TIMING18_SY_DIVN_EN_RX_LO(0x69+PHY_EN_DELAY + RFNA_DEL)|
                XCVR_TSM_TIMING18_SY_DIVN_EN_TX_HI(0x05 + RFNA_DEL)|
                XCVR_TSM_TIMING18_SY_DIVN_EN_TX_LO(0x65 + RFNA_DEL),
#endif /* RF_OSC_26MHZ == 1 */

    /* TIMING19 configuration, dependencies: ['COM', 'COM', 'COM', 'COM'] */
    .timing19 = XCVR_TSM_TIMING19_SY_PD_FILTER_CHARGE_EN_RX_HI(0x03 + RFNA_DEL)|
                XCVR_TSM_TIMING19_SY_PD_FILTER_CHARGE_EN_RX_LO(0x18 + RFNA_DEL)|
                XCVR_TSM_TIMING19_SY_PD_FILTER_CHARGE_EN_TX_HI(0x03 + RFNA_DEL)|
                XCVR_TSM_TIMING19_SY_PD_FILTER_CHARGE_EN_TX_LO(0x4C + RFNA_DEL),

    /* TIMING20 configuration, dependencies: ['COM', 'COM', 'COM', 'COM'] */
#if RF_OSC_26MHZ == 1
    .timing20 = XCVR_TSM_TIMING20_SY_PD_EN_RX_HI(0x03 + RFNA_DEL)|
                XCVR_TSM_TIMING20_SY_PD_EN_RX_LO(0x6D+PHY_EN_DELAY + RFNA_DEL)|
                XCVR_TSM_TIMING20_SY_PD_EN_TX_HI(0x03 + RFNA_DEL)|
                XCVR_TSM_TIMING20_SY_PD_EN_TX_LO(0x65 + RFNA_DEL),
#else
    .timing20 = XCVR_TSM_TIMING20_SY_PD_EN_RX_HI(0x03 + RFNA_DEL)|
                XCVR_TSM_TIMING20_SY_PD_EN_RX_LO(0x69+PHY_EN_DELAY + RFNA_DEL)|
                XCVR_TSM_TIMING20_SY_PD_EN_TX_HI(0x03 + RFNA_DEL)|
                XCVR_TSM_TIMING20_SY_PD_EN_TX_LO(0x65 + RFNA_DEL),
#endif /* RF_OSC_26MHZ == 1 */
...
#if RF_OSC_26MHZ == 1
    .timing21 = XCVR_TSM_TIMING21_SY_LO_DIVN_EN_RX_HI(0x04 + RFNA_DEL)|
                XCVR_TSM_TIMING21_SY_LO_DIVN_EN_RX_LO(0x6D+PHY_EN_DELAY + RFNA_DEL)|
                XCVR_TSM_TIMING21_SY_LO_DIVN_EN_TX_HI(0x04 + RFNA_DEL)|
                XCVR_TSM_TIMING21_SY_LO_DIVN_EN_TX_LO(0x65 + RFNA_DEL),
#else
    .timing21 = XCVR_TSM_TIMING21_SY_LO_DIVN_EN_RX_HI(0x04 + RFNA_DEL)|
                XCVR_TSM_TIMING21_SY_LO_DIVN_EN_RX_LO(0x69+PHY_EN_DELAY + RFNA_DEL)|
                XCVR_TSM_TIMING21_SY_LO_DIVN_EN_TX_HI(0x04 + RFNA_DEL)|
                XCVR_TSM_TIMING21_SY_LO_DIVN_EN_TX_LO(0x65 + RFNA_DEL),
#endif /* RF_OSC_26MHZ == 1 */
...
#if RF_OSC_26MHZ == 1
    .timing22 = XCVR_TSM_TIMING22_SY_LO_RX_EN_RX_HI(0x04 + RFNA_DEL)|
                XCVR_TSM_TIMING22_SY_LO_RX_EN_RX_LO(0x6D+PHY_EN_DELAY + RFNA_DEL),
#else
    .timing22 = XCVR_TSM_TIMING22_SY_LO_RX_EN_RX_HI(0x04 + RFNA_DEL)|
                XCVR_TSM_TIMING22_SY_LO_RX_EN_RX_LO(0x69+PHY_EN_DELAY + RFNA_DEL),
#endif /* RF_OSC_26MHZ == 1 */

    /* TIMING23 configuration, dependencies: ['COM', 'COM'] */
    .timing23 = XCVR_TSM_TIMING23_SY_LO_TX_EN_TX_HI(0x04 + RFNA_DEL)|
                XCVR_TSM_TIMING23_SY_LO_TX_EN_TX_LO(0x65 + RFNA_DEL),

    /* TIMING24 configuration, dependencies: ['COM', 'COM', 'COM', 'COM'] */
    .timing24 = XCVR_TSM_TIMING24_SY_DIVN_CAL_EN_RX_HI(0x00 + RFNA_DEL)|
                XCVR_TSM_TIMING24_SY_DIVN_CAL_EN_RX_LO(0x18 + RFNA_DEL)|
                XCVR_TSM_TIMING24_SY_DIVN_CAL_EN_TX_HI(0x00 + RFNA_DEL)|
                XCVR_TSM_TIMING24_SY_DIVN_CAL_EN_TX_LO(0x4C + RFNA_DEL),

    /* TIMING25 configuration, dependencies: ['COM', 'COM'] */
#if RF_OSC_26MHZ == 1
    .timing25 = XCVR_TSM_TIMING25_RX_LNA_MIXER_EN_RX_HI(0x21 + RFNA_DEL)|
                XCVR_TSM_TIMING25_RX_LNA_MIXER_EN_RX_LO(0x6D+PHY_EN_DELAY + RFNA_DEL),
#else
    .timing25 = XCVR_TSM_TIMING25_RX_LNA_MIXER_EN_RX_HI(0x1D + RFNA_DEL)|
                XCVR_TSM_TIMING25_RX_LNA_MIXER_EN_RX_LO(0x69+PHY_EN_DELAY + RFNA_DEL),
#endif /* RF_OSC_26MHZ == 1 */

    /* TIMING27 configuration, dependencies: ['COM', 'COM'] */
#if RF_OSC_26MHZ == 1
    .timing27 = XCVR_TSM_TIMING27_RX_ADC_I_Q_EN_RX_HI(0x24 + RFNA_DEL)|
                XCVR_TSM_TIMING27_RX_ADC_I_Q_EN_RX_LO(0x6D+PHY_EN_DELAY + RFNA_DEL),
#else
    .timing27 = XCVR_TSM_TIMING27_RX_ADC_I_Q_EN_RX_HI(0x20 + RFNA_DEL)|
                XCVR_TSM_TIMING27_RX_ADC_I_Q_EN_RX_LO(0x69+PHY_EN_DELAY + RFNA_DEL),
#endif /* RF_OSC_26MHZ == 1 */

    /* TIMING28 configuration, dependencies: ['COM', 'COM'] */
#if RF_OSC_26MHZ == 1
    .timing28 = XCVR_TSM_TIMING28_RX_ADC_RESET_EN_RX_HI(0x24 + RFNA_DEL)|
                XCVR_TSM_TIMING28_RX_ADC_RESET_EN_RX_LO(0x25 + RFNA_DEL),
#else
    .timing28 = XCVR_TSM_TIMING28_RX_ADC_RESET_EN_RX_HI(0x20 + RFNA_DEL)|
                XCVR_TSM_TIMING28_RX_ADC_RESET_EN_RX_LO(0x21 + RFNA_DEL),
#endif /* RF_OSC_26MHZ == 1 */

    /* TIMING29 configuration, dependencies: ['COM', 'COM'] */
#if RF_OSC_26MHZ == 1
    .timing29 = XCVR_TSM_TIMING29_RX_BBA_I_Q_EN_RX_HI(0x22 + RFNA_DEL)|
                XCVR_TSM_TIMING29_RX_BBA_I_Q_EN_RX_LO(0x6D+PHY_EN_DELAY + RFNA_DEL),
#else
    .timing29 = XCVR_TSM_TIMING29_RX_BBA_I_Q_EN_RX_HI(0x1E + RFNA_DEL)|
                XCVR_TSM_TIMING29_RX_BBA_I_Q_EN_RX_LO(0x69+PHY_EN_DELAY + RFNA_DEL),
#endif /* RF_OSC_26MHZ == 1 */

    /* TIMING30 configuration, dependencies: ['COM', 'COM'] */
#if RF_OSC_26MHZ == 1
    .timing30 = XCVR_TSM_TIMING30_RX_BBA_PDET_EN_RX_HI(0x24 + RFNA_DEL)|
                XCVR_TSM_TIMING30_RX_BBA_PDET_EN_RX_LO(0x6D+PHY_EN_DELAY + RFNA_DEL),
#else
    .timing30 = XCVR_TSM_TIMING30_RX_BBA_PDET_EN_RX_HI(0x20 + RFNA_DEL)|
                XCVR_TSM_TIMING30_RX_BBA_PDET_EN_RX_LO(0x69+PHY_EN_DELAY + RFNA_DEL),
#endif /* RF_OSC_26MHZ == 1 */

    /* TIMING31 configuration, dependencies: ['COM', 'COM'] */
#if RF_OSC_26MHZ == 1
    .timing31 = XCVR_TSM_TIMING31_RX_BBA_TZA_DCOC_EN_RX_HI(0x23 + RFNA_DEL)|
                XCVR_TSM_TIMING31_RX_BBA_TZA_DCOC_EN_RX_LO(0x6D+PHY_EN_DELAY + RFNA_DEL),
#else
    .timing31 = XCVR_TSM_TIMING31_RX_BBA_TZA_DCOC_EN_RX_HI(0x1F + RFNA_DEL)|
                XCVR_TSM_TIMING31_RX_BBA_TZA_DCOC_EN_RX_LO(0x69+PHY_EN_DELAY + RFNA_DEL),
#endif /* RF_OSC_26MHZ == 1 */

    /* TIMING32 configuration, dependencies: ['COM', 'COM'] */
#if RF_OSC_26MHZ == 1
    .timing32 = XCVR_TSM_TIMING32_RX_TZA_I_Q_EN_RX_HI(0x21 + RFNA_DEL)|
                XCVR_TSM_TIMING32_RX_TZA_I_Q_EN_RX_LO(0x6D+PHY_EN_DELAY + RFNA_DEL),
#else
    .timing32 = XCVR_TSM_TIMING32_RX_TZA_I_Q_EN_RX_HI(0x1D + RFNA_DEL)|
                XCVR_TSM_TIMING32_RX_TZA_I_Q_EN_RX_LO(0x69+PHY_EN_DELAY + RFNA_DEL),
#endif /* RF_OSC_26MHZ == 1 */

    /* TIMING33 configuration, dependencies: ['COM', 'COM'] */
#if RF_OSC_26MHZ == 1
    .timing33 = XCVR_TSM_TIMING33_RX_TZA_PDET_EN_RX_HI(0x24 + RFNA_DEL)|
                XCVR_TSM_TIMING33_RX_TZA_PDET_EN_RX_LO(0x6D+PHY_EN_DELAY + RFNA_DEL),
#else
    .timing33 = XCVR_TSM_TIMING33_RX_TZA_PDET_EN_RX_HI(0x20 + RFNA_DEL)|
                XCVR_TSM_TIMING33_RX_TZA_PDET_EN_RX_LO(0x69+PHY_EN_DELAY + RFNA_DEL),
#endif /* RF_OSC_26MHZ == 1 */

    /* TIMING34 configuration, dependencies: ['COM', 'COM', 'COM', 'COM'] */
#if RF_OSC_26MHZ == 1
    .timing34 = XCVR_TSM_TIMING34_PLL_DIG_EN_RX_HI(0x07 + RFNA_DEL)|
                XCVR_TSM_TIMING34_PLL_DIG_EN_RX_LO(0x6D+PHY_EN_DELAY + RFNA_DEL)|
                XCVR_TSM_TIMING34_PLL_DIG_EN_TX_HI(0x07 + RFNA_DEL)|
                XCVR_TSM_TIMING34_PLL_DIG_EN_TX_LO(0x65 + RFNA_DEL),
#else
    .timing34 = XCVR_TSM_TIMING34_PLL_DIG_EN_RX_HI(0x07 + RFNA_DEL)|
                XCVR_TSM_TIMING34_PLL_DIG_EN_RX_LO(0x69+PHY_EN_DELAY + RFNA_DEL)|
                XCVR_TSM_TIMING34_PLL_DIG_EN_TX_HI(0x07 + RFNA_DEL)|
                XCVR_TSM_TIMING34_PLL_DIG_EN_TX_LO(0x65 + RFNA_DEL),
#endif /* RF_OSC_26MHZ == 1 */
...
#if RF_OSC_26MHZ == 1
    .timing35 = XCVR_TSM_TIMING35_TX_DIG_EN_TX_HI(0x5F + RFNA_DEL)|
                XCVR_TSM_TIMING35_TX_DIG_EN_TX_LO(0x65 + RFNA_DEL),
#else
    .timing35 = XCVR_TSM_TIMING35_TX_DIG_EN_TX_HI(0x5F + RFNA_DEL)|
                XCVR_TSM_TIMING35_TX_DIG_EN_TX_LO(0x65 + RFNA_DEL),
#endif /* RF_OSC_26MHZ == 1 */
...
#if RF_OSC_26MHZ == 1
    .timing36 = XCVR_TSM_TIMING36_RX_DIG_EN_RX_HI(0x6A + RFNA_DEL)|
                XCVR_TSM_TIMING36_RX_DIG_EN_RX_LO(0x6D+PHY_EN_DELAY + RFNA_DEL),
#else
    .timing36 = XCVR_TSM_TIMING36_RX_DIG_EN_RX_HI(0x66 + RFNA_DEL)|
                XCVR_TSM_TIMING36_RX_DIG_EN_RX_LO(0x69+PHY_EN_DELAY + RFNA_DEL),
#endif /* RF_OSC_26MHZ == 1 */

    /* TIMING37 configuration, dependencies: ['COM', 'COM'] */
#if RF_OSC_26MHZ == 1
    .timing37 = XCVR_TSM_TIMING37_RX_INIT_RX_HI(0x6A + RFNA_DEL)|
                XCVR_TSM_TIMING37_RX_INIT_RX_LO(0x6B + RFNA_DEL),
#else
    .timing37 = XCVR_TSM_TIMING37_RX_INIT_RX_HI(0x66 + RFNA_DEL)|
                XCVR_TSM_TIMING37_RX_INIT_RX_LO(0x67 + RFNA_DEL),
#endif /* RF_OSC_26MHZ == 1 */

    /* TIMING38 configuration, dependencies: ['COM', 'COM', 'COM', 'COM'] */
#if RF_OSC_26MHZ == 1
    .timing38 = XCVR_TSM_TIMING38_SIGMA_DELTA_EN_RX_HI(0x0E + RFNA_DEL)|
                XCVR_TSM_TIMING38_SIGMA_DELTA_EN_RX_LO(0x6D+PHY_EN_DELAY + RFNA_DEL)|
                XCVR_TSM_TIMING38_SIGMA_DELTA_EN_TX_HI(0x42 + RFNA_DEL)|
                XCVR_TSM_TIMING38_SIGMA_DELTA_EN_TX_LO(0x65 + RFNA_DEL),
#else
    .timing38 = XCVR_TSM_TIMING38_SIGMA_DELTA_EN_RX_HI(0x0E + RFNA_DEL)|
                XCVR_TSM_TIMING38_SIGMA_DELTA_EN_RX_LO(0x69+PHY_EN_DELAY + RFNA_DEL)|
                XCVR_TSM_TIMING38_SIGMA_DELTA_EN_TX_HI(0x42 + RFNA_DEL)|
                XCVR_TSM_TIMING38_SIGMA_DELTA_EN_TX_LO(0x65 + RFNA_DEL),
#endif /* RF_OSC_26MHZ == 1 */
...
#if RF_OSC_26MHZ == 1
    .timing39 = XCVR_TSM_TIMING39_RX_PHY_EN_RX_HI(0x6A+PHY_EN_DELAY + RFNA_DEL)|
                XCVR_TSM_TIMING39_RX_PHY_EN_RX_LO(0x6D+PHY_EN_DELAY + RFNA_DEL),
#else
    .timing39 = XCVR_TSM_TIMING39_RX_PHY_EN_RX_HI(0x66+PHY_EN_DELAY + RFNA_DEL)|
                XCVR_TSM_TIMING39_RX_PHY_EN_RX_LO(0x69+PHY_EN_DELAY + RFNA_DEL),
#endif /* RF_OSC_26MHZ == 1 */

    /* TIMING40 configuration, dependencies: ['COM', 'COM'] */
#if RF_OSC_26MHZ == 1
    .timing40 = XCVR_TSM_TIMING40_DCOC_EN_RX_HI(0x2A + RFNA_DEL)|
                XCVR_TSM_TIMING40_DCOC_EN_RX_LO(0x6D+PHY_EN_DELAY + RFNA_DEL),
#else
    .timing40 = XCVR_TSM_TIMING40_DCOC_EN_RX_HI(0x26 + RFNA_DEL)|
                XCVR_TSM_TIMING40_DCOC_EN_RX_LO(0x69+PHY_EN_DELAY + RFNA_DEL),
#endif /* RF_OSC_26MHZ == 1 */

    /* TIMING41 configuration, dependencies: ['COM', 'COM'] */
#if RF_OSC_26MHZ == 1
    .timing41 = XCVR_TSM_TIMING41_DCOC_INIT_RX_HI(0x2A + RFNA_DEL)|
                XCVR_TSM_TIMING41_DCOC_INIT_RX_LO(0x2B + RFNA_DEL),
#else
    .timing41 = XCVR_TSM_TIMING41_DCOC_INIT_RX_HI(0x26 + RFNA_DEL)|
                XCVR_TSM_TIMING41_DCOC_INIT_RX_LO(0x27 + RFNA_DEL),
#endif /* RF_OSC_26MHZ == 1 */
...
#if RF_OSC_26MHZ == 1
    .timing51 = XCVR_TSM_TIMING51_RXTX_AUXPLL_BIAS_EN_RX_HI(0x03 + RFNA_DEL)|
                XCVR_TSM_TIMING51_RXTX_AUXPLL_BIAS_EN_RX_LO(0x6D+PHY_EN_DELAY + RFNA_DEL),
#else
    .timing51 = XCVR_TSM_TIMING51_RXTX_AUXPLL_BIAS_EN_RX_HI(0x03 + RFNA_DEL)|
                XCVR_TSM_TIMING51_RXTX_AUXPLL_BIAS_EN_RX_LO(0x69+PHY_EN_DELAY + RFNA_DEL),
#endif /* RF_OSC_26MHZ == 1 */

    /* TIMING52 configuration, dependencies: ['COM', 'COM'] */
#if RF_OSC_26MHZ == 1
    .timing52 = XCVR_TSM_TIMING52_RXTX_AUXPLL_FCAL_EN_RX_HI(0x06 + RFNA_DEL)|
                XCVR_TSM_TIMING52_RXTX_AUXPLL_FCAL_EN_RX_LO(0x1B + RFNA_DEL),
#else
    .timing52 = XCVR_TSM_TIMING52_RXTX_AUXPLL_FCAL_EN_RX_HI(0x06 + RFNA_DEL)|
                XCVR_TSM_TIMING52_RXTX_AUXPLL_FCAL_EN_RX_LO(0x17 + RFNA_DEL),
#endif /* RF_OSC_26MHZ == 1 */

    /* TIMING53 configuration, dependencies: ['COM', 'COM'] */
#if RF_OSC_26MHZ == 1
    .timing53 = XCVR_TSM_TIMING53_RXTX_AUXPLL_LF_PD_EN_RX_HI(0x03 + RFNA_DEL)|
                XCVR_TSM_TIMING53_RXTX_AUXPLL_LF_PD_EN_RX_LO(0x6D+PHY_EN_DELAY + RFNA_DEL),
#else
    .timing53 = XCVR_TSM_TIMING53_RXTX_AUXPLL_LF_PD_EN_RX_HI(0x03 + RFNA_DEL)|
                XCVR_TSM_TIMING53_RXTX_AUXPLL_LF_PD_EN_RX_LO(0x69+PHY_EN_DELAY + RFNA_DEL),
#endif /* RF_OSC_26MHZ == 1 */

    /* TIMING54 configuration, dependencies: ['COM', 'COM'] */
#if RF_OSC_26MHZ == 1
    .timing54 = XCVR_TSM_TIMING54_RXTX_AUXPLL_PD_LF_FILTER_CHARGE_EN_RX_HI(0x03 + RFNA_DEL)|
                XCVR_TSM_TIMING54_RXTX_AUXPLL_PD_LF_FILTER_CHARGE_EN_RX_LO(0x1B + RFNA_DEL),
#else
    .timing54 = XCVR_TSM_TIMING54_RXTX_AUXPLL_PD_LF_FILTER_CHARGE_EN_RX_HI(0x03 + RFNA_DEL)|
                XCVR_TSM_TIMING54_RXTX_AUXPLL_PD_LF_FILTER_CHARGE_EN_RX_LO(0x17 + RFNA_DEL),
#endif /* RF_OSC_26MHZ == 1 */

    /* TIMING55 configuration, dependencies: ['COM', 'COM'] */
#if RF_OSC_26MHZ == 1
    .timing55 = XCVR_TSM_TIMING55_RXTX_AUXPLL_ADC_BUF_EN_RX_HI(0x24 + RFNA_DEL)|
                XCVR_TSM_TIMING55_RXTX_AUXPLL_ADC_BUF_EN_RX_LO(0x6D+PHY_EN_DELAY + RFNA_DEL),
#else
    .timing55 = XCVR_TSM_TIMING55_RXTX_AUXPLL_ADC_BUF_EN_RX_HI(0x20 + RFNA_DEL)|
                XCVR_TSM_TIMING55_RXTX_AUXPLL_ADC_BUF_EN_RX_LO(0x69+PHY_EN_DELAY + RFNA_DEL),
#endif /* RF_OSC_26MHZ == 1 */

    /* TIMING56 configuration, dependencies: ['COM', 'COM'] */
#if RF_OSC_26MHZ == 1
    .timing56 = XCVR_TSM_TIMING56_RXTX_AUXPLL_DIG_BUF_EN_RX_HI(0x24 + RFNA_DEL)|
                XCVR_TSM_TIMING56_RXTX_AUXPLL_DIG_BUF_EN_RX_LO(0x6D+PHY_EN_DELAY + RFNA_DEL),
#else
    .timing56 = XCVR_TSM_TIMING56_RXTX_AUXPLL_DIG_BUF_EN_RX_HI(0x20 + RFNA_DEL)|
                XCVR_TSM_TIMING56_RXTX_AUXPLL_DIG_BUF_EN_RX_LO(0x69+PHY_EN_DELAY + RFNA_DEL),
#endif /* RF_OSC_26MHZ == 1 */

    /* TIMING57 configuration, dependencies: ['COM', 'COM'] */
    .timing57 = XCVR_TSM_TIMING57_RXTX_RCCAL_EN_RX_HI(0x03 + RFNA_DEL)|
                XCVR_TSM_TIMING57_RXTX_RCCAL_EN_RX_LO(0x1A + RFNA_DEL),

    /* TIMING58 configuration, dependencies: ['COM', 'COM'] */
    .timing58 = XCVR_TSM_TIMING58_TX_HPM_DAC_EN_TX_HI(0x03 + RFNA_DEL)|
#if RF_OSC_26MHZ == 1
                XCVR_TSM_TIMING58_TX_HPM_DAC_EN_TX_LO(0x65 + RFNA_DEL),
#else
                XCVR_TSM_TIMING58_TX_HPM_DAC_EN_TX_LO(0x65 + RFNA_DEL),
#endif /* RF_OSC_26MHZ == 1 */
