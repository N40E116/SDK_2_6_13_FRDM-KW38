...
#if !defined(RFNA_DEL)
#define RFNA_DEL               (4U) /* Additional delay added to all TSM timings for Gen 3.5 to allow for RF_NOT_ALLOWED recognition before LDOs start */
#endif /* !defined(RFNA_DEL) */
...
#define TX_RX_SYNTH_init_B0    (0x00006918UL+((RFNA_DEL)<<8U)) /* TX_RX_SYNTH initialization for KW37 B0 silicon plus fix for RF_NOT_ALLOWED detection at start */
